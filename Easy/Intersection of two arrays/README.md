<h2><a href="https://practice.geeksforgeeks.org/problems/intersection-of-two-arrays2404/1?page=1&category[]=two-pointer-algorithm&sortBy=submissions">Intersection of two arrays</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given two arrays&nbsp;<strong>a[]</strong> and <strong>b[]</strong> respectively of size <strong>n</strong> and <strong>m, </strong>the task is to print the count of elements in the intersection (or common elements) of the two arrays.</span></p>
